...
void Exercise2() {
	...
	Worker* worker[4];
	std::cout << "\nCameraMan #1\n";
	worker[0] = new CameraMan("Dmitry", "Davidenko", 1, "2002", "2020", 12.1, 10);
...
int main()
{
	cout << "\n Gricishin Nikita | 8 Variant | Lab #3\n\n";
        Exercise1();
		Exercise2();
		return 0;
}
